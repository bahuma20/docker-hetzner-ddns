...
* `-e FRITZ_BOX_ADDRESS` - If set it will determine the IP from this fritzbox. Can be a domain name (like `fritz.box`) or an IP address (like `192.168.178.1`). If not set it will determine IP from some online service.
